...
(function ($) {
	...
	$(window).on('load scroll resize', function () {
		if ($(window).scrollTop() >= 66) {
			if (!$('#mainNav').hasClass('is-stuck')) $('#mainNav').addClass('is-stuck');
		} else {
			if ($('#mainNav').hasClass('is-stuck')) $('#mainNav').removeClass('is-stuck');
		}
	});
	...
	$(document).ready(function () {
		$("#lng").click(function () {
			$("#lng").addClass("active");
			$("#lng2").removeClass("active");
			$("#lng3").removeClass("active");
		});
		$("#lng2").click(function () {
			$("#lng2").addClass("active");
			$("#lng").removeClass("active");
			$("#lng3").removeClass("active");
		});
		$("#lng3").click(function () {
			$("#lng3").addClass("active");
			$("#lng").removeClass("active");
			$("#lng2").removeClass("active");
		});
	});
	...
	$('#topMenu').each(function () {
		...
		$(document).on('keyup', function (event) {
			if (event.key == 'Escape') $this.collapse('hide');
		});
...
function changeContentLanguage(event) {
  ...
  return isNotCurrentLanguage ? renderContentOnPage(language) && storeInNavigator(language) : storeInNavigator(language);
}
...
function renderContentBy(language) {
  ...
  return isFirstAccess ? setUserNavigatorDefaultLanguage(language) : renderContentOnPage(storedLanguage);
}
...
function setUserNavigatorDefaultLanguage(language) {
  ...
  return hasPortugueseInNavigator ? renderContentOnPage('ru') && storeInNavigator('ru') : hasSpanishInNavigator ? renderContentOnPage('ua') && storeInNavigator('ua') : renderContentOnPage('en') && storeInNavigator('en');
}
